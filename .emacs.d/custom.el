(custom-set-variables
 ...
 '(package-selected-packages
   '(pcmpl-args org-review casual-suite corfu tree-sitter-langs tree-sitter-ess-r emacsql-sqlite-builtin olivetti sqlite3 casual gptel build flymake-php embark-consult embark eat activities rhtml-mode rg denote org-modern use-package modus-themes theme-anchor eshell-git-prompt dirvish peep-dired quarto-mode emmet-mode visual-fill-column hide-mode-line jsonrpc eglot detached typescript-mode texfrag all-the-icons all-the-icons-dired dired-sidebar auctex yaml-mode polymode bash-completion csv-mode zotxt geiser-guile guix keychain-environment multiple-cursors ghub magit forge smartparens python-mode go-mode markdown-mode dash pcre2el julia-mode julia-repl julia-shell ess epc simpleclip poly-R poly-markdown poly-org lsp-mode purpose-mode window-purpose solarize-theme gnu-elpa-keyring-update hyperbole exwme exwm matlab-mode easy-hugo font-lock-studio gist  r-autoyas pretty-symbols flucui-themes company flycheck image+ groovy-mode f dired+ highlight-parentheses))
 )
